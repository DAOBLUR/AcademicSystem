...
namespace AcademicSystem.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(AcademicSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Courses != null ? 
                          ...
                          Problem("Entity set 'AcademicSystemContext.Courses'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AcademicSystemContext.Courses'  is null.");
            }
            var course = await _context.Courses.FindAsync(id);
            if (course != null)
            {
